...
//       if( !obj->effects.isEmpty() && ( camera.p - obj->p ).sqL() < DMAX_SQ ) {
//         for( Effect *snd = obj->effects.first(); snd != null; snd = snd->next[0] ) {
//
//           // non-continous
//           if( snd->flags & Effect::CONTINOUS_BIT ) {
//           Source *src = new Source();
//
//           alGenSources( 1, &src->source );
//           alSourcei( src->source, AL_BUFFER, buffers[ snd->id ] );
